...
<style>
body{background:#F9A4DA;}
#box1{border:1px solid aquamarine;padding-left:200px;color:white;}
...
#show{background:#EF7C8E;}
</style>
</head>
<body>
<a href="index.php" style="color:white;font-size:20px;">Home Page</a>
<?php
	...
	echo"<h1 style='color:#fff;background:#EF7C8E;text-align:center;line-height:50px;height:50px;'>Your Address</h1>";
		echo"<div id='box1'>";
...
?>
					<div id="show">
						<h1 style="color:#fff;background:#EF7C8E;text-align:center;line-height:50px;height:50px;">Your orders</h1>
