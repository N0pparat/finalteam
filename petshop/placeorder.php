...
<head>
<style>
#show{width:90%;height:auto;background:#fff;margin-left:70px;border-radius:4px;border:2px solid #6495ED;margin-top:20px;}
#show table{border:1px solid #6495ED;;width:100%;border-collapse:collapse;}
...
?>
	<div id="show">
	<h1 style="width:100%;height:40px;line-height:40px;background:#6495ED;color:#fff;text-align:center;margin-top:20px;">order Details</h1>
				<table>
				<tr>
					<th>S.No</th>
					<th>Name</th>
				...
				?>
				<tr><td colspan="4" style="text-align:right;border-top:1px solid #6495ED;"><b style="color:red;font-size:25px;">Total</b></td>
				<td style="border-top:1px solid #6495ED;border-bottom:1px solid #6495ED;">฿. <b style="font-size:20px;"> <?php echo"".$b."";?></b></td></tr>
...
<tr><td colspan="5"><form method="post"><input type="submit" name="place" value="placeOrder" style="padding:10px;border:1px solid #425298;color:#425298;background:#fff;border-radius:4px;"></form></td></tr>			
		...
		<h1 style="width:95%;text-align:center;background:#6495ED;color:#fff;height:50px;line-height:50px;margin-left:30px;margin-top:10px;border-radius:4px;margin-bottom:10px;">Order Details table </h1>
				<table>
				<tr>
					<th>S.No</th>
					<th>Name</th>
				...
				<?php
						...
						echo"<tr>
							...
							<td>฿. ".$row2['pet_rate']."</td>
							<td><b>".$row1['qty']." </b><form method='get'><input type='text' name='qty' value='".$row1['qty']."' style='width:40px;height:20px;'><input type='hidden' name='cart_id' value='".$row1['cart_id']."' style='width:40px;height:20px;'><input type='submit' name='upqty' value='add' style='width:40px;height:20px;background:#fff;color:#6495ED;border:1px solid #6495ED;margin-left:10px;'></form></td>
