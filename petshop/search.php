...
include("header_index.php");
		...
		$query->execute();
		echo"<div id='pet'>
<h1 style='padding-left:10px;margin-left:60px;
margin-top:20px;width:92%;background:#6495ED;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;
border-radius:4px;'>Search keyword like '".$_GET['keyword']."'</h1>";
