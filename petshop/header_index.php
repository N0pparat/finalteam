...
<style>
*{margin:0%;}
#header{background:#6495ED;width:100%;height:150px;}
#header img{width:250px;height:150px;border-radius:5px;}
#header h1{text-align:center;margin-top:-150px;color:#fff;}
#header ul li{float:right;margin-right:40px;font-size:24px;color:#6495ED;list-style-type:circle;margin-top:-20px;}
#header ul li a{color:#fff;text-decoration:none;}
</style>
</head>
<body>
<div id="header">
	<a href="index.php"><img src="a22.gif" style="border:1px solid #6495ED;"></a>
	<h1>Home Wash</h1>
	...
	if(isset($_COOKIE['usernameget']))
				...
				<form method="post">
		<input type="text" name="search1" required style="margin-left:740px;margin-top:30px;width:400px;
		height:40px;border-radius:4px;border:1px solid #425298;">
		<input type="submit" name="search" value="Search" style="margin-left:1px;margin-top:-40px;
		width:70px;height:40px;border-radius:100px;border:1px solid #425298;background:#fff;color:#425298;">
	</form>
</div>
</body>
</html>
