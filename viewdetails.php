...
#pet2 ul li{background:#fff;color:#400040;float:left;margin-top:10px;margin-right:20px;list-style-type:circle;font-size:24px;border:1px solid #400400;margin-left:20px;}
...
<form method="post">
<h1 style="margin-top:5px;width:95%;height:40px;line-height:40px;background:#EF7C8E;color:#F6E72D;text-align:center;margin-left:20px;padding-left:10px;border-radius:4px;border:1px solid aquamrine;"><?php echo"".$row['pet_name']."";?></h1>
		<div id="pet1">
			<ul>
		...
		$query->execute();
		echo"<div id='pet'>
		<h1 style='padding-left:10px;margin-left:60px;margin-top:20px;width:92%;background:#EF7C8E;color:#F6E72D;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;'>Relative Pets</h1>";
		while($row1=$query->fetch()):
			...
			echo"<ul>
				<li><a href='viewdetails.php?id=".$row1['pet_id']."'>
					...
					<h1 style='text-align:center;font-size:20px;font-weight:normal;margin-top:10px;'>Rate (THB.".$row1['pet_rate'].")</h1>
				</a></li>
			</ul>";
...
<h1 style="padding-left:10px;margin-left:60px;margin-top:28%;width:92%;background:#EF7C8E;color:#F6E72D;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;">Feedbacks</h1>
...
<div id="feedback">
	...
	<input type="submit" name="insert_feedback" value="feedback">
		...
		<h3 style="color:#EF7C8E">Customer images</h3>
			<?php
