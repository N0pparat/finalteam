...
table td{text-align:center;padding:10px;font-size:20px;}
		...
		<body>
				...
				?>
				<h1 style="width:95%;text-align:center;background:#6495ED;color:#fff;height:50px;line-height:50px;margin-left:30px;margin-top:10px;border-radius:4px;margin-bottom:10px;">Cart Table </h1>
				<table>
				<tr>
					<th>S.No</th>
					<th>Name</th>
				...
				?>
				<tr><td colspan="6" style="text-align:right;border-top:1px solid #400040;"><b style="color:red;font-size:25px;">Total</b></td><td style="border-top:1px solid #400040;border-bottom:1px solid #400040;">฿.  <?php echo"".$b."";?></td></tr>
				</table>
