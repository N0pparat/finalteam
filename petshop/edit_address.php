...
<?php  
 ...
 ?>
	...
	<div class="container-signup">
		...
		<input type="text" name="phoneno" required placeholder="Enter Phone Number" value="<?php echo"".$row['phoneno'].""; ?>">
			 ...
			 <input type="text" name="city" required placeholder="Enter City" value="<?php echo"".$row['city'].""; ?>">
			  <input type="text" name="pincode" required placeholder="Enter Pincode" pattern="[0-9]{5}" value="<?php echo"".$row['pincode'].""; ?>">
