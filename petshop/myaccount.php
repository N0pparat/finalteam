...
#box1{border:1px solid #6495ED;padding-left:200px;color:#000;}
...
<body>
<a href="index.php" style="color:red;font-size:40px;text-decoration:#fff;">Home Page</a>
<?php
	...
	echo"<h1 style='color:#fff;background:#6495ED;text-align:center;line-height:50px;height:50px;'>Your Address</h1>";
		echo"<div id='box1'>";
		...
		echo"<h2>".$row['phoneno']."</h2><br><a href='edit_address.php?userid=".$row['id']."'><input type='submit' value='Edit' style='margin-bottom:20px;width:70px;height:40px;border-radius:4px;background:#fff;border:1px solid #6495ED;'></a>";
	
		echo"</div>";
		
		echo"<img src='userphotos/".$row['user_img']."' style='width:400px;height:330px;float:right;margin-top:-355px;margin-right:200px;border-radius:4px;border:1px solid #6495ED;'/>";
?>
					<div id="show">
						<h1 style="color:#fff;background:#6495ED;text-align:center;line-height:50px;height:50px;">Your order</h1>
						<hr style="color:#6495ED;">
						<table>
				<tr>
					<th>S.No</th>
					<th>Name</th>
