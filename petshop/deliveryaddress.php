...
<head>
<style>
#showadd{color:#6495ED;width:90%;height:400px;background:#fff;margin-left:100px;border-radius:4px;border-radius:4px;border:2px solid #6495ED;margin-top:20px;}
		...
		if(isset($_COOKIE['usernameget']))
				{
					...
					echo"<div id='showadd'>
						<h1 style='width:100%;height:40px;line-height:40px;background:#6495ED;color:#fff;text-align:center;margin-top:20px;'>Delivery to this Address</h1>
